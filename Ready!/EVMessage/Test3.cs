...
namespace SigningAndEnvelopingMessage
{
    ...
    {
        const String signerName = "Billev farmacija vzhod d.o.o.";
        ...
        static void Main(string[] args)
        {
            ...
            X509Certificate2 signerCert = new X509Certificate2(@"C:\hrvoje_temp\cert\Billev SI w Private Key.pfx", "P0ss1T");
