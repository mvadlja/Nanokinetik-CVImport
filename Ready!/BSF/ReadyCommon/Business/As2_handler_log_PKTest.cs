...
namespace Ready.Model
{
	...
	[GEMDataSourceBinding(DataSourceId = "Default", ConnectionStringName = "Ready_poss_wcTest")]
	public class As2_handler_log_PKTest
	{
		...
		public As2_handler_log_PKTest() { }
        public As2_handler_log_PKTest(Int32? as2_handler_log_PK, DateTime? log_time, String event_type, String description, DateTime? received_time, String message_number, String as2_to, String as2_from, String message_ID, String filename, Int32? received_message_FK, String connection, String date, String content_length, String content_type, String from, String host, String user_agent, String mime_version, String content_transfer_encoding, String content_disposition, String disposition_notification_to, String disposition_notification_options, String receipt_delivery_option, String ediint_features, String as2_version)
		{
    ...
    public interface IAs2_handler_log_PKTestOperations : ICRUDOperations<As2_handler_log_PKTest>
	{
