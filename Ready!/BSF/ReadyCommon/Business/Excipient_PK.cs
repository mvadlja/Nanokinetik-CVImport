...
{
	[Serializable()]
	[GEMAuditing(DataSourceId = "Default", Database = "Ready_poss_wc", Table = "PP_EXCIPIENT")]
	[GEMOperationsLogging(DataSourceId = "Default", Active = true)]
	[GEMDataSourceBinding(DataSourceId = "Default", ConnectionStringName = "Ready_poss_wc")]
	public class Excipient_PK
	{
        private Int32? _excipient_PK;
        ...
        public Int32? excipient_PK
        {
            get { return _excipient_PK; }
            set { _excipient_PK = value; }
        }
	...
	public interface IExcipient_PKOperations : ICRUDOperations<Excipient_PK>
	{
		List<Excipient_PK> GetExcipientsByPPPK(Int32? pharmaceutical_product_FK);
