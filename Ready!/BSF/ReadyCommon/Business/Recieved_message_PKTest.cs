...
namespace Ready.Model
{
	...
	public class Recieved_message_PKTest
	{
        ...
        public Recieved_message_PKTest() { }
        public Recieved_message_PKTest(Int32? recieved_message_PK, Byte[] msg_data, DateTime? received_time, DateTime? processed_time, Boolean? processed, Boolean? is_successfully_processed, Int32? msg_type, String as_header, String processing_error, Int32? xevmpd_FK, Int32? status)
        {
    ...
    public interface IRecieved_message_PKTestOperations : ICRUDOperations<Recieved_message_PKTest>
	{
        List<Recieved_message_PKTest> GetNotProcessedMessages();
	}
}
