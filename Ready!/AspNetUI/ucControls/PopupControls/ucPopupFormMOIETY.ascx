<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="ucPopupFormMOIETY.ascx.cs" Inherits="AspNetUI.ucControls.PopupControls.ucPopupFormMOIETY" %>
...
<div id="PopupControls_Entity_Container" runat="server" class="modal">
    ...
    <div id="PopupControls_Entity_ContainerContent" class="modal_container_MOIETY">
        ...
        <div id="modalPopupContainerBody" runat="server" class="modal_content">
            ...
            <asp:Panel ID="pnlFormContainer" runat="server" GroupingText="" Width="100%">
                ...
                <table cellpadding="2" cellspacing="0" width="100%">
                    <tr>
                        <td>
                            <asp:Panel ID="pnlMoiety" runat="server" Visible="true">
                                <br />
                                <customControls:DropDownList_CT ID="ctlMoietyRole" runat="server" LabelColumnWidth="150px" ControlInputWidth="200px" ControlLabel="Moiety role: " IsMandatory="true" ControlErrorMessage="" ControlEmptyErrorMessage="Moiety role can't be empty." />
                                ...
                                <tr>
                                    <td align="right" style="width: 150px;">
                                        <asp:Label ID="ctlMoietyName" Text="Moiety Name: "  runat="server" />
                                    </td>
                                    <td width="6px"><asp:Label ID="MoietyNameAsterix" Text="*" runat="server" ForeColor="Red"/></td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td width="8px"/>
                                    <td>
                                        <asp:TextBox ID="EVCODESearcherDisplay" Width="195px" runat="server" ReadOnly="true" Text =""/>
                                    </td>
                                </tr>
                                </table>
                            </asp:Panel>
                                ...
                                <tr>
                                    <td align="right" style="width: 160px;">
                                        <asp:Label ID="ctlMoietyID" Text="Moiety ID:" runat="server"></asp:Label>
                                    </td>
                                    <td>
