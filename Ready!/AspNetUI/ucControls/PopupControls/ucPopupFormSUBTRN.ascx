<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="ucPopupFormSUBTRN.ascx.cs" Inherits="AspNetUI.ucControls.PopupControls.ucPopupFormSUBTRN" %>
                ...
                <table cellpadding="2" cellspacing="0" width="100%">
                    <tr>
                        <td>
                            ...
                            <customControls:TextArea_CT ID="ctlTerm" runat="server" LabelColumnWidth="150px" ControlInputWidth="294px" ControlLabel="Term" IsMandatory="true" ControlErrorMessage="" ControlEmptyErrorMessage="Term can't be empty." MaxLength="2000" />
                        </td>
                    </tr>
                </table>
            </asp:Panel>
