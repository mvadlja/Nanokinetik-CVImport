<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Error.aspx.cs" Inherits="AspNetUI.Error" %>
            ...
            <table cellpadding="0" cellspacing="0" class="layoutHeader">
                <tr>
                    <td class="layoutHeaderLeftRightCells">
                        <a href="~/Views/ActivityView/List.aspx?EntityContext=Activity" id="linkLogo" runat="server">
                ...
                <tr>
                    <td class="layoutContent">
                        ...
                        <table cellpadding="10" cellspacing="0" width="100%">
                            <tr>
                                <td colspan="2"><asp:Label id="lblHead" runat="server" Text="There was an error in application!" Font-Bold="true" Font-Size="12px" /></td>
                            </tr>
                            <tr>
