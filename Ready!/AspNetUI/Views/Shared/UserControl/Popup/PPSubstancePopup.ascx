<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="PPSubstancePopup.ascx.cs" Inherits="AspNetUI.Views.Shared.UserControl.Popup.PPSubstancePopup" %>
    ...
    <div id="PopupControls_Entity_ContainerContent" class="modal_container">
        ...
        <div id="modalPopupContainerBody" runat="server" class="modal_content disable-table-hover">
            <asp:Panel ID="pnlFormContainer" runat="server" GroupingText="" Width="100%">
                <br />
                <asp:Panel ID="pnlAdjuvants" runat="server" Visible="true">
                    ...
                    <asp:Panel ID="pnlInfo" runat="server" GroupingText="Full description" ClientIDMode="Static" >
                        <div id="info" runat="server" style="text-align: left;">
                    ...
                    <asp:Panel ID="pnlExactLimit" runat="server" GroupingText="Exact value" Visible="true" ClientIDMode="Static" >
                        ...
                        <table cellpadding="2" cellspacing="0" width="100%" class="popup-form-table">
                            <tr>
                                <td>
                                </td>
                                <td>
                                    <span style="padding-left: 28px">Value</span>
                                </td>
                                <td>
