<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Template/Default.Master" AutoEventWireup="false" CodeBehind="List.aspx.cs" Inherits="AspNetUI.Views.ServiceLogView.List" %>
...
<asp:Content ID="contentBodyMain" ContentPlaceHolderID="cphBodyMain" runat="server">
    ...
    <asp:Panel ID="pnlGrid" runat="server" Visible="True">
        ...
        <possGrid:PossGrid ID="ServiceLogGrid" GridId="ServiceLogGrid" GridVersion="1" runat="server" AllowPaging="True" PageSize="18" AutoGenerateColumns="false"
            CellPadding="4" DataKeyNames="service_log_PK" AllowSorting="true" GridLines="None" GridHeight="250" Width="100%" MainSortingColumn="log_time" DefaultSortingOrder="ASC">
            ...
            <Columns>
                <possGrid:PossBoundField Width="5%" Caption="ID" FieldName="service_log_PK" FilterType="Text" />
                <possGrid:PossBoundField Width="10%" Caption="Log time" FieldName="log_time" FilterType="Text" />
                <possGrid:PossBoundField Width="75%" Caption="Description" FieldName="description" FilterType="Text" />
                <possGrid:PossBoundField Width="10%" Caption="Responsible user" FieldName="responsible_user" FilterType="Text" />
            </Columns>
