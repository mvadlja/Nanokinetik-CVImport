<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Template/Default.Master" AutoEventWireup="false" CodeBehind="List.aspx.cs" Inherits="AspNetUI.Views.ApprovedSubstanceView.List" %>
...
<asp:Content ID="contentBodyMain" ContentPlaceHolderID="cphBodyMain" runat="server">
    ...
    <asp:Panel ID="pnlGrid" runat="server" Visible="True">
        ...
        <possGrid:PossGrid ID="ApprovedSubstanceGrid" GridId="ApprovedSubstanceGrid" GridVersion="1" runat="server" AllowPaging="True" PageSize="18" AutoGenerateColumns="false"
            CellPadding="4" DataKeyNames="approved_substance_PK" AllowSorting="true" GridLines="None" GridHeight="250" Width="100%" MainSortingColumn="SubstanceName" DefaultSortingOrder="ASC">
            ...
            <Columns>
                <possGrid:PossBoundField Width="5%" Caption="ID" FieldName="approved_substance_PK" Visible="False" FilterType="Text" />
                <possGrid:PossTemplateField Width="28%" Caption="Name" FieldName="SubstanceName" FilterType="Text">
                    <ItemTemplate>
                        <asp:HyperLink ID="hlName" runat="server" CssClass="gvLinkTextBold" NavigateUrl='<%# "~/Views/ApprovedSubstanceView/Form.aspx?EntityContext=ApprovedSubstance&Action=Edit&idAprSub=" + Eval("approved_substance_PK")%>' Text='<%# Eval("SubstanceName") %>' Font-Bold="true"></asp:HyperLink>
                    </ItemTemplate>
                </possGrid:PossTemplateField>

                <possGrid:PossBoundField Caption="EVCODE" FieldName="EvCode" Width="10%" FilterType="Text" />
                <possGrid:PossBoundField Caption="CAS number" FieldName="CasNumber" Width="10%" FilterType="Text" />
                <possGrid:PossBoundField Caption="Molecular formula" FieldName="MolecularFormula" Width="10%" FilterType="Text" />
                <possGrid:PossBoundField Caption="Class" FieldName="Class" Width="10%" FilterType="Text" />
                <possGrid:PossBoundField Caption="CDB" FieldName="CDB" Width="6%" FilterType="Text" />
                <possGrid:PossBoundField Caption="Comment" FieldName="Comment" Width="20%" FilterType="Text" />

                <possGrid:PossTemplateField Width="2%" Caption="" FieldName="Delete" FilterType="None">
                    <ItemTemplate>
                        <asp:ImageButton runat="server" CommandName="Delete" CommandArgument='<%# Eval("approved_substance_PK") %>' ImageUrl="~/Images/delete.gif" OnClick="btnDeleteEntity_OnClick" />
                    </ItemTemplate>
                </possGrid:PossTemplateField>
            </Columns>
