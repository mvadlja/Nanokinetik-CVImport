<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Template/Default.Master" AutoEventWireup="false" CodeBehind="List.aspx.cs" Inherits="AspNetUI.Views.XevprmView.List" %>
...
<asp:Content ID="contentBodyMain" ContentPlaceHolderID="cphBodyMain" runat="server">
    ...
    <div id="contextMenu_ContextMenuLayout" class="controlButtons" style="margin-top: 0px; margin-bottom: 0px;">
    </div>
    ...
    <asp:Panel ID="pnlGrid" runat="server" Visible="True">
        ...
        <possGrid:PossGrid ID="XevprmGrid" GridId="XevprmGrid" GridVersion="1" runat="server" AllowPaging="True" PageSize="18" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <possGrid:PossBoundField Width="6%" Caption="Authorisation number" FieldName="AuthorisationNumber" FilterType="Text" />
                ...
                <possGrid:PossTemplateField Width="7%" Caption="xEVPRM Status" FieldName="XevprmStatus" FilterType="Combo">
                    <ItemTemplate>
                        ...
                        <asp:LinkButton ID="btnStatus" runat="server" Font-Bold="true" ForeColor="Red" CommandArgument='<%# Eval("xevprm_message_PK") %>' 
                            Text='<%# Eval("XevprmStatus") %>' Visible="False" OnClick="btnStatus_OnClick"></asp:LinkButton>
                    </ItemTemplate>
                </possGrid:PossTemplateField>
                ...
                <possGrid:PossBoundField Width="3%" Caption="MSG PDF" FieldName="XevprmXmlPdf" FilterType="Text" Visible="False" />
                <possGrid:PossBoundField Width="3%" Caption="MSG RTF" FieldName="XevprmXmlRtf" FilterType="Text" Visible="False" />
                ...
                <possGrid:PossBoundField Width="3%" Caption="ACK PDF" FieldName="AckXmlPdf" FilterType="Text" Visible="False" />
                <possGrid:PossBoundField Width="3%" Caption="ACK RTF" FieldName="AckXmlRtf" FilterType="Text" Visible="False" />
