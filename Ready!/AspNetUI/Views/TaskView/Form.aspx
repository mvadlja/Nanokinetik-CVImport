<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Template/Default.Master" AutoEventWireup="false" CodeBehind="Form.aspx.cs" Inherits="AspNetUI.Views.TaskView.Form" %>
...
<asp:Content ID="contentBodyMain" ContentPlaceHolderID="cphBodyMain" runat="server">
    ...
    <asp:Panel ID="pnlForm" runat="server" class="form preventableClose">
        <div id="divLeftPane" class="leftPane">
            <fieldset>
                <uc:TextBoxSr ID="txtSrActivity" runat="server" Label="Activity:" Required="True" SearchType="Activity" />
                <uc:DropDownList ID="ddlTaskName" runat="server" Label="Task name:" Required="True"/>
                <uc:TextBox ID="txtTaskId" runat="server" Label="Task ID:" />
