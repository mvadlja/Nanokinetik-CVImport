<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ModalPopupContainer.ascx.cs" Inherits="AspNetUI.Support.ModalPopupContainer" %>


<div id="modalPopupContainer" runat="server" class="modal">

    <div id="modalPopupContainerContent" class="modal_container_small">
...
<%--<center>
    <div id="modalPopupContainer" runat="server" style="display: none;">
        
        <div class="modalOverlay"></div>
        <div id="modalPopupContainerContent" class="modalPopupPanel">
            <center>
