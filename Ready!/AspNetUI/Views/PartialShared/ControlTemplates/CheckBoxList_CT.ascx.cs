...
{
    public partial class CheckBoxList_CT : System.Web.UI.UserControl, IControlCommon, IControlList
    {
        ...
        public int RepeatColumnsCount
        {
            get { return ctlInput.RepeatColumns; }
            set { ctlInput.RepeatColumns = value; }
        }
            ...
            if (source != null)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        ctlInput.Items.Add(new ListItem(String.Empty, source[0].ToString()));
                    }
                }
            }
        }
