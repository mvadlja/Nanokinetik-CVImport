...
{
    public partial class DropDownList_CT : System.Web.UI.UserControl, IControlCommon, IControlList
    {
        ...
        private string _dropDownListID;
        ...
        public string ControlTextValue
        {
            get
            {
                return ctlInput.Items.FindByValue( this.ControlValue.ToString() ).Text;
            }
        }
        #endregion
        ...
        public void FillControl<T>(IList<T> source)
        {
            ...
            ctlInput.Items.Insert(0, new ListItem("- Choose -", ""));
        }
