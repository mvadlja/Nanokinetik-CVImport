<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListBox_CT.ascx.cs" Inherits="AspNetUI.Support.ListBox_CT" %>
...
<table id="tableCanvas" runat="server" cellpadding="2" cellspacing="0">
    <tr>
        ...
        <td id="tdControl" runat="server">
            <asp:ListBox ID="ctlInput" runat="server" 
                onselectedindexchanged="ctlInput_SelectedIndexChanged" style="background-color:#F4F4F4;"/>
        </td>
