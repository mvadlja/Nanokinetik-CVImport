<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="TextBox_CT.ascx.cs" Inherits="AspNetUI.Support.TextBox_CT" %>
...
<table id="tableCanvas" runat="server" cellpadding="2" cellspacing="0">
    <tr>
        ...
        <td id="tdControl" runat="server">
            <asp:TextBox ID="ctlInput" runat="server" ontextchanged="ctlInput_TextChanged" />
        </td>
