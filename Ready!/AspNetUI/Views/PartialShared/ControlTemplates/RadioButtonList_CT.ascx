<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="RadioButtonList_CT.ascx.cs" Inherits="AspNetUI.Support.RadioButtonList_CT" %>
...
<table id="tableCanvas" runat="server" cellpadding="2" cellspacing="0">
    <tr>
        ...
        <td id="tdControl" runat="server">
            <asp:RadioButtonList ID="ctlInput" runat="server" RepeatDirection="Horizontal"
