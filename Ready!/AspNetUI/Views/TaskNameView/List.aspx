<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Template/Default.Master" AutoEventWireup="false" CodeBehind="List.aspx.cs" Inherits="AspNetUI.Views.TaskNameView.List" %>
...
<asp:Content ID="contentBodyMain" ContentPlaceHolderID="cphBodyMain" runat="server">
    ...
    <asp:Panel ID="pnlGrid" runat="server" Visible="True">
        ...
        <possGrid:PossGrid ID="TaskNameGrid" GridId="TaskNameGrid" GridVersion="1" runat="server" AllowPaging="True" PageSize="18" AutoGenerateColumns="false"
            CellPadding="4" DataKeyNames="task_name_PK" AllowSorting="true" GridLines="None" GridHeight="250" Width="100%" MainSortingColumn="TaskName" DefaultSortingOrder="ASC">
            ...
            <Columns>
                <possGrid:PossBoundField Width="3%" Caption="ID" FieldName="task_name_PK" Visible="False" FilterType="Text" />
                <possGrid:PossTemplateField Width="95%" Caption="Name" FieldName="TaskName" FilterType="Text">
                    <ItemTemplate>
                        <asp:HyperLink ID="hlName" runat="server" CssClass="gvLinkTextBold" NavigateUrl='<%# "~/Views/TaskNameView/Form.aspx?EntityContext=TaskName&Action=Edit&From=TaskName&idTaskName=" + Eval("task_name_PK")%>' Text='<%# Eval("TaskName") %>' Font-Bold="true"></asp:HyperLink>
                    </ItemTemplate>
                </possGrid:PossTemplateField>

                <possGrid:PossTemplateField Width="2%" Caption="" FieldName="Delete" FilterType="None">
                    <ItemTemplate>
                        <asp:ImageButton runat="server" CommandName="Delete" CommandArgument='<%# Eval("task_name_PK") %>' ImageUrl="~/Images/delete.gif" OnClick="btnDeleteEntity_OnClick" />
                    </ItemTemplate>
                </possGrid:PossTemplateField>
            </Columns>
