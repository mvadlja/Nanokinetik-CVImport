<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Template/Default.Master" AutoEventWireup="false" CodeBehind="List.aspx.cs" Inherits="AspNetUI.Views.ProductXevprmView.List" %>
...
<asp:Content ID="contentBodyMain" ContentPlaceHolderID="cphBodyMain" runat="server">
    ...
    <asp:Panel ID="pnlGrid" runat="server" Visible="True">
        ...
        <possGrid:PossGrid ID="ProductXevprmGrid" GridId="ProductXevprmGrid" GridVersion="1" runat="server" AllowPaging="True" PageSize="18" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <possGrid:PossTemplateField Width="3%" Caption="MSG" FieldName="XevprmXml" FilterType="Text">
                    <ItemTemplate>
                        <asp:HyperLink ID="hlXML" runat="server" Visible="true" Text="XML"></asp:HyperLink><br />
                        <asp:HyperLink ID="hlPDF" runat="server" Visible="true" Text="PDF"></asp:HyperLink><br />
                        <asp:HyperLink ID="hlRTF" runat="server" Visible="true" Text="RTF"></asp:HyperLink>
                    </ItemTemplate>
                </possGrid:PossTemplateField>
                ...
                <possGrid:PossTemplateField Width="5%" Caption="Submission status" FieldName="GatewaySubmissionStatus" FilterType="Combo">
                    <ItemTemplate>
                        <asp:Label ID='lblGatewaySubmissionStatus' Font-Bold="true" Visible="false" runat="server" Text='<%# Eval("GatewaySubmissionStatus") %>' />
                ...
                <possGrid:PossTemplateField Width="2%" Caption="" FieldName="Delete" FilterType="None">
                    <ItemTemplate>
                        <asp:ImageButton ID="imgBtnDelete" runat="server" CommandName="Delete" CommandArgument='<%# Eval("xevprm_message_PK") %>' ImageUrl="~/Images/delete.gif" OnClick="btnDeleteEntity_OnClick" />
                    </ItemTemplate>
                </possGrid:PossTemplateField>
