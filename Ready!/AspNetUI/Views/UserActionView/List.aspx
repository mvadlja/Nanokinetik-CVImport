<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Template/Default.Master" AutoEventWireup="false" CodeBehind="List.aspx.cs" Inherits="AspNetUI.Views.UserActionView.List" %>
...
<asp:Content ID="contentBodyMain" ContentPlaceHolderID="cphBodyMain" runat="server">
    ...
    <asp:Panel ID="pnlGrid" runat="server" Visible="True">
        ...
        <possGrid:PossGrid ID="UserActionGrid" GridId="UserActionGrid" GridVersion="1" runat="server" AllowPaging="True" PageSize="18" AutoGenerateColumns="false"
            ...
            <Columns>
                <possGrid:PossBoundField Width="5%" Caption="ID" FieldName="user_action_PK" Visible="False" FilterType="Text" />
                <possGrid:PossTemplateField Width="25%" Caption="Display name" FieldName="display_name" FilterType="Text">
                    <ItemTemplate>
                        <asp:HyperLink ID="hlName" runat="server" CssClass="gvLinkTextBold" NavigateUrl='<%# "~/Views/UserActionView/Form.aspx?EntityContext=UserAction&Action=Edit&From=UserAction&idUserAction=" + Eval("user_action_PK")%>' Text='<%# Eval("display_name") %>' Font-Bold="true"></asp:HyperLink>
                    </ItemTemplate>
                </possGrid:PossTemplateField>

                <possGrid:PossBoundField Caption="Action" FieldName="unique_name" Width="23%" FilterType="Text" />
                <possGrid:PossBoundField Caption="Description" FieldName="description" Width="40%" FilterType="Text" />
                <possGrid:PossBoundField Caption="Active" FieldName="Active" Width="10%" FilterType="Combo" />

                <possGrid:PossTemplateField Width="2%" Caption="" FieldName="Delete" FilterType="None">
                    <ItemTemplate>
                        <asp:ImageButton runat="server" CommandName="Delete" CommandArgument='<%# Eval("user_action_PK") %>' ImageUrl="~/Images/delete.gif" OnClick="btnDeleteEntity_OnClick" />
                    </ItemTemplate>
                </possGrid:PossTemplateField>
            </Columns>
