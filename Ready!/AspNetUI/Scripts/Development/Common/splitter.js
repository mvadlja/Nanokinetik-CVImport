...
(function ($, undefined) {
    ...
    $.fn.split = function (options) {
        ...
        var leftPane = $("#" + $(this).attr("id") + "_leftPane");

        var leftPanePaddingTop = leftPane.css("padding-top").replace("px", "");
        var leftPanePaddingBottom = leftPane.css("padding-bottom").replace("px", "");
        var leftPanePaddingLeft = leftPane.css("padding-left").replace("px", "");
        var leftPanePaddingRight = leftPane.css("padding-right").replace("px", "");

        var rightPane = $("#" + $(this).attr("id") + "_rightPane");

        var rightPanePaddingTop = rightPane.css("padding-top").replace("px", "");
        var rightPanePaddingBottom = rightPane.css("padding-bottom").replace("px", "");
        var rightPanePaddingLeft = rightPane.css("padding-left").replace("px", "");
        var rightPanePaddingRight = rightPane.css("padding-right").replace("px", "");
                ...
                if (settings.orientation == 'vertical') {
                    return function (n) {
                        if (n === undefined) {
                            ...
                            panel_1.width(n - sw - leftPanePaddingLeft - leftPanePaddingRight);
                            panel_1.height(self.height() - leftPanePaddingTop - leftPanePaddingBottom);

                            panel_2.width(self.width() - n - sw - rightPanePaddingLeft - rightPanePaddingRight);
                            panel_2.height(self.height() - rightPanePaddingTop - rightPanePaddingBottom);
                        }
                    };
                } else if (settings.orientation == 'horizontal') {
                    return function (n) {
                        if (n === undefined) {
                            ...
                            panel_1.height(n - sw - leftPanePaddingTop - leftPanePaddingRight);
                            panel_1.width(self.width() - leftPanePaddingLeft - leftPanePaddingRight);

                            panel_2.height(self.height() - n - sw - rightPanePaddingLeft - rightPanePaddingRight);
                            panel_2.width(self.width() - rightPanePaddingLeft - rightPanePaddingRight);
