CREATE TABLE [dbo].[PP_EXCIPIENT] (
    [excipient_PK]          INT             IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_PP_EXCIPIENT] PRIMARY KEY CLUSTERED ([excipient_PK] ASC),
    CONSTRAINT [FK_PP_EXCIPIENT_PHARMACEUTICAL_PRODUCT] FOREIGN KEY ([pp_FK]) REFERENCES [dbo].[PHARMACEUTICAL_PRODUCT] ([pharmaceutical_product_PK]) ON DELETE CASCADE,
    CONSTRAINT [FK_PP_EXCIPIENT_SUBSTANCES] FOREIGN KEY ([substancecode_FK]) REFERENCES [dbo].[SUBSTANCES] ([substance_PK])
);
