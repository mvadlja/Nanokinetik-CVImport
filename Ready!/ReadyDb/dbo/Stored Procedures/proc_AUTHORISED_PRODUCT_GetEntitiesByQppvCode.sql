CREATE PROCEDURE  [dbo].[proc_AUTHORISED_PRODUCT_GetEntitiesByQppvCode]
	@QppvCodeFk INT = NULL
AS
BEGIN
	SET NOCOUNT ON;
	...
	[qppvcode_person_FK], [product_ID], [ev_code],[qppv_code_FK],
	 [dbo].[ReturnAuthorisedProductXevprmStatus]([ap_PK]) AS xevprm_message_status_FK,
