-- proc_ATC_GetSearcher
CREATE PROCEDURE  [dbo].[proc_ATC_GetSearcher]
	@code nvarchar(100) = NULL,
	@name nvarchar(100) = NULL,
	@PageNum int = 1,
	@PageSize int = 20,
	@OrderByQuery nvarchar(1000) = '[ATC Code]'
AS
...
BEGIN
	...
	(
		...
		DistinctATC.* FROM
		(
			select DISTINCT f.atc_PK AS ID, f.atccode AS [ATC Code], f.[name] as Name
			from (
