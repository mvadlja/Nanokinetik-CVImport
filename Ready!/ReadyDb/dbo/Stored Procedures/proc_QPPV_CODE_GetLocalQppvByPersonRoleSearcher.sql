-- ProductsSearcher
CREATE PROCEDURE  [dbo].[proc_QPPV_CODE_GetLocalQppvByPersonRoleSearcher]
	...
	(
		...
		(
			...
			BEGIN
				...
				SET @TempWhereQuery = @TempWhereQuery + '[dbo].[PERSON_ROLE].[person_name] LIKE ''' + CONVERT (nvarchar(MAX), 'Local QPPV') + ''''
			END
