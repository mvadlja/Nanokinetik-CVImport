-- Save
CREATE PROCEDURE  [dbo].[proc_PRODUCT_ORGANIZATION_PARTNER_MN_Save]
...
BEGIN
	...
	UPDATE [dbo].[PRODUCT_ORGANIZATION_PARTNER_MN]
	SET
	...
	BEGIN
		...
		INSERT INTO [dbo].[PRODUCT_ORGANIZATION_PARTNER_MN]
