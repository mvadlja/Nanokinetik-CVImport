...
BEGIN
	...
	BEGIN
		...
		([list_name], [term_id], [term_name_english], [latin_name_latin], [synonim1], [synonim2], [Description], [Field8], [Field9], [Field10], [Field11], [Field12], [Field13], [Field14], [evcode])
		VALUES
		(@list_name, @term_id, @term_name_english, @latin_name_latin, @synonim1, @synonim2, @Description, @Field8, @Field9, @Field10, @Field11, @Field12, @Field13, @Field14, @evcode)
