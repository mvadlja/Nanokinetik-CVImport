-- GetEntitiesWP
CREATE PROCEDURE  [dbo].[proc_APPROVED_SUBST_SUBST_ALIAS_TRANS_MN_GetEntitiesWP]
	@PageNum int = 1,
	@PageSize int = 20
AS
BEGIN
	...
	(
		SELECT ROW_NUMBER() OVER(ORDER BY [approved_subst_sub_alias_trans_PK]) AS RowNum,
